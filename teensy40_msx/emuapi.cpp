...
static uint16_t readAnalogJoystick(void)
{
  ...
  //ykp74 if (xReading > 128) joysval |= MASK_JOY2_LEFT;
  //ykp74 else if (xReading < 128) joysval |= MASK_JOY2_RIGHT;
  
  if (xReading > 128) joysval |= MASK_JOY2_RIGHT;
  else if (xReading < 128) joysval |= MASK_JOY2_LEFT;

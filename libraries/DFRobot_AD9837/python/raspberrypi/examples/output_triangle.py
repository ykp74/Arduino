...
'''!
  ...
  @note  The amplitude of the triangular wave signal is about 0.645V; the wave phase offset must be observed with reference; VCC to 3.3V
...
def setup():
  ...
  '''
    # @brief The parts of AD9837 that are not in use like the internal clock and DAC can be powered down through hibernation function to minimize power consumption.
  ...
  '''
  AD9837.output_triangle_wave(phase=0, freq=1000.0)

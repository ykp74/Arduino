...
'''!
  ...
  @brief  Drive the AD9837 via SPI to output a square wave signal
  ...
  @n  Set the frequency, phase offset and two-way frequency of the square wave signal
  @note  The amplitude of the square wave signal approximately equals to VCC voltage; the wave phase offset must be observed with reference; VCC to 3.3V
...
def setup():
  ...
  '''
  AD9837.output_square_wave(divide=AD9837.e_DIV2_1, phase=0, freq=1000.0)

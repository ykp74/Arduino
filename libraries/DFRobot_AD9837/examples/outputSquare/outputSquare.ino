 ...
 * @note  The amplitude of the square wave signal approximately equals to VCC voltage; the wave phase offset must be observed with reference.
...
void setup(void)
{
  ...
  /**
   * @brief Reset internal register to 0, this corresponds to analog output of midscale.
